...
struct TintColorFlipKey: EnvironmentKey {
    static var defaultValue: UIColor {
        #if os(iOS)
        return UIColor { $0.userInterfaceStyle == .light ?  #colorLiteral(red: 0.5830795169, green: 0.8262143731, blue: 0.4173913896, alpha: 1) : #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1) }
        #else
